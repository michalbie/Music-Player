...
const actions = {
    getFirstInfo({ commit }) {
        ...
        axios.post("https://michalbie-music-player.herokuapp.com/getMusicStructure", JSON.stringify(obj)).then(response => {
    ...
    getCovers({ commit }) {
        ...
        const fetchData = async () => {
            let resp = await fetch(`https://michalbie-music-player.herokuapp.com/getMusicStructure`, {
                method: "post",
                mode: "cors",
    ...
    getPlaylists({ commit }) {
        ...
        axios.post("https://michalbie-music-player.herokuapp.com/getPlaylists", JSON.stringify(obj)).then(response => {
    ...
    addSongToPlaylist({ commit }, data) {
        ...
        axios.post("https://michalbie-music-player.herokuapp.com/modifyPlaylist", JSON.stringify(obj)).then(response => {
